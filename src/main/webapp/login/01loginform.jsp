...
<body>
	...
	<script>
		function checkValue() {
			inputForm=eval("document.logininfo") /* 아래의 정보 가지고옴 */
			
			if(!inputForm.id.value){
				alert("아이디없음");
				return false; /* 리턴을 false화 해주지 않으면 클릭시 무조건 화면이 넘어감 */	
			}
		...
		function goJoinForm() {
			location.href="../joinus/01join.jsp";
		}
	</script>
	<div id="wrap">
		<form action="02loginproc.jsp" name="logininfo" method="post" onsubmit="return checkValue()"> <!--버튼을 누르면 'chaekValue'값을 'submit'으로 'return'  -->
